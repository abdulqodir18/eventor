...
function AdminUpload() {
   ...
   useEffect(()=> {
      ...
      fetch(`http://eventor.uz:5000/api/user/uploadPhoto`, {
         method: 'PUT',
         body: formData,
         headers: {
         ...
         <div className="wrapper">
            <form className="uploade__form" onSubmit={e => Upload(e)}>
               <div className="uploade__inner">
                  <img className="uploade__img" src={ data.success ? 'http://eventor.uz:5000'+data?.data[1][0]?.imageSrc : "http://eventor.uz:5000"+ img.data?.imageSrc} alt=""  width="300" height="300"/>
